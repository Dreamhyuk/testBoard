...
public class BoardController {
    ...
    public String boardList(Model model,
        ...
        int nowPage = list.getPageable().getPageNumber() + 1; //pageable.getPageNumber(); 해도 된다.
    ...
    public String boardUpdate(@PathVariable("boardId") Integer boardId, Board board, Model model, MultipartFile file) throws Exception{
